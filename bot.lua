local bot_api_key = "TOKEN" --You315802477:AA315802477:AAFl1VrjL9mpoKoy bot api key
...
print("BlackSupport Bot Crashed!!")sudo apt-get updatesudo apt-get install libreadline-dev libconfig-dev libssl-dev lua5.2 liblua5.2-dev lua-socket lua-sec lua-expat libevent-dev make unzip git redis-server autoconf g++ libjansson-dev libpython-dev expat libexpat1-devgit clone https://github.com/Mehdi-HS/Black-Support-Bot.gitcd Black-Support-Botscreenchmod +x launch.sh./launch.sh install./launch.sh
